...
@Component({
  selector: 'ngx-future-job',
  templateUrl: './future-job.component.html',
  styleUrls: ['./future-job.component.scss']
})
export class FutureJobComponent implements OnInit {
  ...
  openfuturejobModal(){
    ...
    this.router.navigate(['/pages/job/future-job-details']);
